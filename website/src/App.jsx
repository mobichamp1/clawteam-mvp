...
const docs = [
  { title: "Quick Start", body: "Install to first running swarm.", href: "https://github.com/mobichamp1/clawteam-mvp#-quick-start" },
  { title: "Skill Guide", body: "Agent-facing operating guide.", href: "https://github.com/mobichamp1/clawteam-mvp/blob/main/README.md" },
  { title: "CLI Reference", body: "Commands, flags, and runtime details.", href: "https://github.com/mobichamp1/clawteam-mvp/blob/main/README.md" },
  { title: "Workflows", body: "Practical patterns for real teams.", href: "https://github.com/mobichamp1/clawteam-mvp/blob/main/README.md" }
];
    ...
    <div className="page">
      ...
      <header className="header">
        <div className="shell header-inner">
          ...
          <a className="btn-primary" href="https://github.com/mobichamp1/clawteam-mvp" target="_blank" rel="noreferrer">GitHub</a>
        </div>
      </header>
      <main>
        <section className="hero shell" id="top">
          <div className="hero-content">
            ...
            <div className="hero-cta">
              <a className="btn-primary" href="https://github.com/mobichamp1/clawteam-mvp#-quick-start" target="_blank" rel="noreferrer">Get started</a>
      ...
      <footer className="footer shell">
        <span>Clawteam</span>
        <div className="footer-links"><a href="https://github.com/mobichamp1/clawteam-mvp">GitHub</a><a href="https://github.com/mobichamp1/clawteam-mvp/blob/main/README.md">README</a><a href="https://github.com/mobichamp1/clawteam-mvp/blob/main/README.md">Docs</a></div>
      </footer>
    </div>
  );
}
